...
export default class SimpleCarModel {
    ...
    setModel() {
        ...
        // Create wheels with better black color
        const wheelGeometry = new THREE.CylinderGeometry(0.5, 0.5, 0.5, 32);

        // Darker but not pure black wheel material with some shine
        ...
        // Improved rim material with more contrast
